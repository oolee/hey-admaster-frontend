...
export const THEMES = [
  { id: 'warm', name: '日曜', preview: 'linear-gradient(135deg, #ff6b35 0%, #ffc24b 100%)' },
  { id: 'ink', name: '墨青', preview: 'linear-gradient(135deg, #142a25 0%, #f5a623 100%)' },
  { id: 'mint', name: '薄荷森林', preview: 'linear-gradient(135deg, #0d9488 0%, #2dd4bf 100%)' },
  { id: 'midnight', name: '紫夜密林', preview: 'linear-gradient(135deg, #9333ea 0%, #ec4899 100%)' },
  { id: 'sand', name: '赤陶沙丘', preview: 'linear-gradient(135deg, #d97706 0%, #92400e 100%)' }
]
...
export const useThemeStore = defineStore('theme', () => {
  ...
  watch(mode, (m) => { isDark.value = m === 'dark' })
