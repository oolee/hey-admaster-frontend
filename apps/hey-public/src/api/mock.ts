/* =====================================================
   Hey 19 V2 · Mock 数据源
   内容基于原产品：门头店招、海报、DM、VI、Logo、名片等
   ===================================================== */
import type {
  V2Addon,
  V2Case,
...
export const mockTemplates: V2Template[] = [
  {
    id: 'mt-1',
    name: '门头设计',
    desc: '标准横版门头',
...
export const mockPricingPlans: V2Plan[] = [
  {
    id: 'starter',
    name: '体验版',
    price: 0,
...
export const mockAddons: V2Addon[] = [
  {
    id: 'a1',
    name: '单次设计',
    price: '¥199 起',
...
export const mockConversations: V2Conversation[] = [
  {
    id: 'c1',
    title: '80×180cm 旅游海报',
    time: '2 分钟前',
...
export const mockChatMessages: V2ChatMessage[] = [
  {
    id: 'm1',
    role: 'user',
...
export const mockNotifications: V2Notification[] = [
  {
    id: 'n1',
    title: '生成完成',
...
export const mockOrders: V2Order[] = [
  {
    id: 'ORD-20260801',
    name: '专业版 · 月付',
    amount: 99,
...
export const mockFavorites: V2Favorite[] = [
  {
    id: 'f1',
    name: '山野菜篮子门头',
    type: '模板',
