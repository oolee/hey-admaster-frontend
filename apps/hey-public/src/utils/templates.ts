...
export const AD_TEMPLATES: AdTemplate[] = [
  // ============ 门头店招 ============
  {
    ...
    promptTemplate: '商业门头招牌设计，店铺名称"{name}"，{style}风格，{material}材质，白天/夜晚效果图，高清写实，适合商业街店面',
    promptHint: '请输入店铺名称、风格偏好（如现代简约/中式/欧式）和材质（如铝塑板/发光字/喷绘布）',
  ...
  },
  {
    ...
    promptTemplate: '3D渲染商业门头效果图，店铺名称"{name}"，{style}风格，包含店面外观、招牌、橱窗展示，建筑可视化，超写实渲染，自然光照，街道背景',
  ...
  // ============ VI设计 ============
  {
    ...
    promptTemplate: '品牌Logo设计，品牌名称"{name}"，行业{industry}，{style}风格，简洁大方，矢量感，白色背景，适合多场景应用',
  ...
  },
  {
    ...
    promptTemplate: '商务名片设计，品牌"{name}"，{industry}行业，{style}风格，名片正面含Logo和联系方式，背面含业务范围，高端质感，印刷效果',
  ...
  },
  {
    ...
    promptTemplate: '企业办公用品设计，品牌"{name}"，信封和信纸套装，{style}风格，含Logo、地址、联系方式，印刷效果，白色纸张',
  ...
  // ============ DM传单 ============
  {
    ...
    promptTemplate: 'DM宣传单设计，{industry}行业，主题"{title}"，{style}风格，A4尺寸，含促销信息、产品图片、联系方式，印刷品效果，商业设计',
  ...
  },
  {
    ...
    promptTemplate: '菜单/价目表设计，{industry}行业，{style}风格，含菜品图片和价格信息，排版清晰，印刷品质，A4或A3尺寸',
  ...
  // ============ 文化墙 ============
  {
    ...
    promptTemplate: '党建文化墙设计，{organization}单位，红色主题，包含入党誓词、党员风采、组织架构等内容板块，庄重大气，适合政府机关和企事业单位',
  ...
  },
  {
    ...
    promptTemplate: '企业文化墙设计，{company}公司，{style}风格，包含企业简介、发展历程、愿景使命、团队风采等板块，现代简约，适合办公区域',
  ...
  },
  {
    ...
    promptTemplate: '校园文化墙设计，{school}学校，{style}风格，包含校训、办学理念、师生风采、荣誉展示等内容，活泼明亮，适合学校走廊或大厅',
  ...
  // ============ 3D效果图 ============
  {
    ...
    promptTemplate: '3D室内效果图，{space}空间，{style}风格，建筑可视化渲染，真实光照，高清材质纹理，专业室内设计视角',
  ...
  },
  {
    ...
    promptTemplate: '3D展台设计效果图，{event}展会，品牌"{name}"，{style}风格，含接待台、展示区、洽谈区，建筑可视化，展会灯光效果',
 ...
 */
export function buildPrompt(template: AdTemplate, userInput: Record<string, string>): string {
