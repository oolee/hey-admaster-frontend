  ...
  <div class="pg">
    <header class="pg-head">
      ...
      <div class="pg-actions">
        <button class="act-btn" @click="toast.info('已导出 CSV')">
          <Download :size="15" /> 导出
        </button>
        <button class="act-btn" @click="toast.info('刷新成功')">
    ...
    <div class="chart-grid">
      ...
      <div class="card chart-wide">
        ...
        <MiniChart
          ...
          "
          :series2="
            data.revenueTrend.map((r) => ({ label: r.label, value: r.cost }))
          "
          type="area"
          series2-label="营收"
        />
          ...
          <div v-for="m in data.modelUsage" :key="m.model" class="rank-row">
            ...
            <div class="rank-bar">
              <div
                class="rank-fill"
                :style="{
                  width: `${(m.calls / data.modelUsage[0].calls) * 100}%`,
                }"
              ></div>
            </div>
