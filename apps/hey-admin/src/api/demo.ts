...
function okMsg(message = '模拟成功'): ApiEnvelope {
...
const USERS = [
  {
    id: 'u_1001',
    name: '王小美',
    email: 'xiaomei@demo.com',
    credits: 1280,
    role: 'user',
    status: 'active',
    createdAt: '2026-07-12T09:24:00',
  },
  {
    id: 'u_1002',
    name: '陈大文',
    email: 'dawen@demo.com',
    credits: 360,
    role: 'admin',
    status: 'active',
...
const SKILLS = [
  {
    ...
    capabilities: ['image', 'layout'],
    enabled: true,
  },
  {
    id: 'sk_logo',
    name: 'Logo 设计',
    description: '根据品牌词生成 Logo',
    capabilities: ['image'],
    enabled: false,
  },
];
...
const AUDIT_LIST = [
  {
    ...
    risk: 'high',
    status: 'pending',
    content: '用户提交了一段包含敏感词的评论…',
    user: 'u_1003',
    type: '评论',
    time: '2026-08-12 09:12',
  },
  {
    id: 'au_2',
    risk: 'medium',
    status: 'reviewing',
    content: 'AI 生成的图片疑似含品牌水印…',
    user: 'u_1004',
    type: '图片',
    time: '2026-08-12 10:40',
  },
];
...
const RECORD_DETAIL = {
  ...
  response_json: {
    ...
    data: [{ url: 'https://demo.hey19.xin/mock/rec1.png' }],
  },
  original_prompt: '帮我做一张奶茶店开业促销海报',
  response_text: null,
  response_images: [
    {
      saved_path: 'https://demo.hey19.xin/mock/rec1.png',
      url: 'https://demo.hey19.xin/mock/rec1.png',
    },
  ],
};
...
export async function request(
  ...
  if (
    url.includes('/api/records?limit=200') ||
    (u === '/api/records' && url.includes('limit=200'))
  ) {
  ...
  if (u === '/api/provider/models' && method === 'GET')
  ...
  // 技能
  if (u === '/api/admin/skills' && method === 'GET')
